...
### CVE ID 申请说明
TCL 是全球第 4XX 家 CVE 编号机构（CNA）。我们可以协助向 TCL CNA 产品清单 报告漏洞的安全研究人员申请 CVE ID。安全研究人员可以将申请发送至 security@tcl.com。TCL SRC 将根据 CVE 要求对漏洞报告进行审核。如果审核未发现问题，TCL SRC 将协助研究人员提交 CVE ID 申请。详情请参阅 CVE ID 提交说明。
